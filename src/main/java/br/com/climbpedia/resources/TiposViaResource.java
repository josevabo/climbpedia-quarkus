    ...
    public Response getTipoViaById(@PathParam("id") Long id) {
		...
		try {
    		...
    		return Response.status(Response.Status.BAD_REQUEST)
    				.entity("Id do tipo de via não encontrado")
    				.build();    		
    	} catch (Exception e) {
    		return Response.status(Response.Status.BAD_REQUEST)
    ...
    public Response deleteTipoViaById(@PathParam("id") Long id) {
    	...
    	try {
	    	...
	    	return Response.status(Response.Status.NOT_FOUND)
	    			.entity("Tipo Via informada não existe: Id " + id.toString())
	    			.build();
		} catch (Exception e) {
	    	return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
		...
		return Response.ok()
				.entity("Tipo Via deletada com sucesso: " + tipoViaResult.toString())
				.build();
